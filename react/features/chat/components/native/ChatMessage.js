...
class ChatMessage extends AbstractChatMessage<Props> {
    ...
    _renderAvatar() {
        ...
        return (
            this.isValidURL(message.displayName) ?
            ...
            <View style={styles.MainContainer}>
                <Text style={styles.TextStyle} onPress={ ()=> Linking.openURL(message.displayName) } ></Text>
          </View>
    ...
    _renderDisplayName() {
        ...
        console.log('msg display called name:************ ' ,message.displayName);
        return (
    ...
    _renderPrivateNotice() {
        ...
        console.log('msg display called private notice: ' ,message.displayName);
