...
function _conferenceJoined({ dispatch, getState }, next, action) {
    console.log("conference joined- mobile app");
    ...
    //start recording when participant count 1
    if(_conference.getParticipantCount() == 1)
    {
        let recordingConfig = {
            mode: 'file',
            ...
            _conference.startRecording(recordingConfig)
    }
    

    console.log("participant count joined -",_conference.getParticipantCount());
